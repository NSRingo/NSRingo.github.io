...
<ModuleInstall urlPrefix="https://github.com/NSRingo/LocationService/releases/latest/download/">
  ...
  <ModuleInstall.Tab type="stash">
    <ModuleInstall.Item
      url="iRingo.Location.stoverride"
      badge={[
        {
          type: "info",
          text: "覆写",
  ...
  <ModuleInstall.Tab type="egern">
    <ModuleInstall.Item
      url="iRingo.Location.yaml"
    />
  </ModuleInstall.Tab>
  <ModuleInstall.Tab type="qx">
    <ModuleInstall.Item
      url="iRingo.Location.snippet"
      badge={[
        {
          type: "danger",
          text: "重写",
