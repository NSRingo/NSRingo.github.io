...
<ModuleInstall urlPrefix="https://github.com/NSRingo/Maps/releases/latest/download/">
...
<ModuleInstall urlPrefix="https://github.com/NSRingo/Maps/raw/main/modules/">
  <ModuleInstall.Tab type="shadowrocket">
    <ModuleInstall.Item
      url="iRingo.Maps.Workers.srmodule"
      badge={[
        {
          type: "tip",
          text: "HTTPS 解密",
  ...
  <ModuleInstall.Tab type="loon">
    <ModuleInstall.Item
      url="iRingo.Maps.Workers.plugin"
      badge={[
        {
          type: "warning",
          text: "重写",
  ...
  <ModuleInstall.Tab type="surge">
    <ModuleInstall.Item 
      url="iRingo.Maps.Workers.sgmodule"
      badge={[
        {
          type: "warning",
          text: "HTTP 重写",
  ...
  <ModuleInstall.Tab type="egern">
    <ModuleInstall.Item
      url="iRingo.Maps.Workers.yaml"
    />
  </ModuleInstall.Tab>
  <ModuleInstall.Tab type="stash">
    <ModuleInstall.Item
      url="iRingo.Maps.Workers.stoverride"
      badge={[
        {
          type: "info",
          text: "改写",
...
## [更新日志](/changelog/GeoServices/maps)
